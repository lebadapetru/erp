 ...
 */
final class Version20210506092236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('
            INSERT INTO 
                "lookup_file_statuses" (id, name, label) 
            VALUES 
                (NEXTVAL(\'lookup_file_statuses_id_seq\'), \'Processing\', \'processing\'),
                (NEXTVAL(\'lookup_file_statuses_id_seq\'), \'Processed\', \'processed\')
            ');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('TRUNCATE "lookup_file_statuses" CASCADE');
        $this->addSql('ALTER SEQUENCE "lookup_file_statuses_id_seq" RESTART WITH 1');
