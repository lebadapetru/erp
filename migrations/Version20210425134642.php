 ...
 */
final class Version20210425134642 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        $this->addSql('
            ...
            VALUES 
                (NEXTVAL(\'lookup_product_statuses_id_seq\'), \'Draft\', null, NOW(), NOW()),
                (NEXTVAL(\'lookup_product_statuses_id_seq\'), \'Order\', null, NOW(), NOW()),
                (NEXTVAL(\'lookup_product_statuses_id_seq\'), \'Active\', null, NOW(), NOW())
            ');
