...
export default {
  ...
  data: function () {
    return {
      ...
      tableItems: [
        {
          avatar: { url: 'build/img/avatars/1.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'build/img/avatars/2.jpg', status: 'danger' },
        ...
        {
          avatar: { url: 'build/img/avatars/3.jpg', status: 'warning' },
        ...
        {
          avatar: { url: 'build/img/avatars/4.jpg', status: '' },
        ...
        {
          avatar: { url: 'build/img/avatars/5.jpg', status: 'success' },
        ...
        {
          avatar: { url: 'build/img/avatars/6.jpg', status: 'danger' },
